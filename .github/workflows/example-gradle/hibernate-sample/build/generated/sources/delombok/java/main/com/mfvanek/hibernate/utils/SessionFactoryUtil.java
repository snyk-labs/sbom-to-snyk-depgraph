...
public final class SessionFactoryUtil {
    ...
    public static SessionFactory build() {
        ...
        try {
            return new MetadataSources(registry).addAnnotatedClass(TestEvent.class).addAnnotatedClass(TestEventInfo.class).buildMetadata().getSessionFactoryBuilder().applyStatementInspector((StatementInspector) sql -> {
